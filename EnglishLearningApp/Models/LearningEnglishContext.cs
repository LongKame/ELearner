...
namespace EnglishLearningApp.Models
{
    public partial class LearningEnglishContext : DbContext
    {
        ...
        public virtual DbSet<PassLevel> PassLevels { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PassLevel>(entity =>
            {
                entity.ToTable("PassLevel");
                ...
                entity.HasOne(d => d.Account)
                    .WithMany(p => p.PassLevels)
                    .HasForeignKey(d => d.AccountId)
                    .HasConstraintName("FK__PassLevel__accou__02FC7413");

                entity.HasOne(d => d.Lesson)
                    .WithMany(p => p.PassLevels)
                    .HasForeignKey(d => d.LessonId)
                    .HasConstraintName("FK__PassLevel__lesso__03F0984C");
            });
